...
__B 弹出框的内容没有显示__(已经修复)

![](http://i1.tietuku.com/6c81d0174d3517c7.png)

####====交易提醒和互动通知（更新于5月18号)=====

交易提醒和互动通知的全选，标记为已读，删除，清空消息的功能全部失效(已经修复)
...
__B 添加商品的图片没有办法添加成功（更新于5月18号)__(已经修复)

![](http://i1.tietuku.com/6d0e271ce91caa31.png)

__C 对于添加商品和删除商品功能的建议（更新于5月18号)__

添加商品控件添加成功后建议出现商品添加成功的提示信息(已经修复)

![](http://i1.tietuku.com/f6e50d46690c25f6.png)

商品添加成功后建议在原页面上显示添加成功商品的信息，而不是需要刷新页面才出现新商品(已经修复)

![](http://i1.tietuku.com/1effd9b4d189994c.png)

商品删除成功后建议在原页面上删除的商品消失，而不是需要刷新页面才将商品删除(已经修复)
